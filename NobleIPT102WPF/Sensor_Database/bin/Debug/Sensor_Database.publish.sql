/*
Deployment script for Noble_SensorDatabse
...
GO
:setvar DatabaseName "Noble_SensorDatabse"
:setvar DefaultFilePrefix "Noble_SensorDatabse"
...
GO
PRINT N'Creating Table [dbo].[Sensor]...';
...
GO
PRINT N'Creating Procedure [dbo].[Create_Sensor]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Delete_Sensor]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Get_Sensor]...';


GO
CREATE PROCEDURE [dbo].[Get_Sensor]
AS
BEGIN
	SELECT * FROM [dbo].[Sensor];
END
GO
PRINT N'Creating Procedure [dbo].[Update_Sensor]...';
